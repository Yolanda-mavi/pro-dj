 ...
 *   https://datatables.net/download/#dt/jq-3.7.0/dt-2.3.7/r-3.0.8
 *
 * Included libraries:
...
function adjustCSS( elem, prop, valueParts, tween ) {
	...
	if ( initialInUnit && initialInUnit[ 3 ] !== unit ) {
		...
		while ( maxIterations-- ) {
			...
			// Finish if the scale equals or crosses 1 (making the old*new modeljs non-positive).
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/jq-3.7.0/dt-2.3.7/r-3.0.8",
