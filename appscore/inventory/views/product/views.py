...
from appscore.inventory.forms import ProductForm, CategoryForm, ProductUomForm, comun_layout,customfield2_layout
from appscore.inventory.models import Product, Category,ProductSupplier,models, Partner, ProductUom
...
class ProductListView(LoginRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('inventoryu:product_create')
        return context
...
class ProductCreateView(LoginRequiredMixin,CreateView):
    ...
    success_url =  reverse_lazy('inventoryu:product_list')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('inventoryu:product_list')
        context['action'] = 'add'
            ...
            if action == 'edit':
                ...
                if form.is_valid():
                    with transaction.atomic():
                        ...
                        #
                        # ProductSupplier.objects.bulk_create(supplier_lines)
                        ##sib obtimizacion de bulk pero este metodo ejecuta sabe y otros eventos
                        # Prod = form.save()
                        #
                        # existing_ids = set(
                        #     ProductSupplier.objects.filter(product_id=Prod.id)
                        ...
                        #
                        #     if line_id:  # ✏️ UPDATE
                        #         ProductSupplier.objects.filter(id=line_id, product_id=Prod.id).update(
                        #             price=line['price'],
                        #             partner_id=line['partner_id']
                        #         )
                        ...
                        #
                        #     else:  # ➕ CREATE
                        #         new_line = ProductSupplier.objects.create(
                        #             product_id=Prod.id,
                        #             price=line['price'],
                        #             partner_id=line['partner_id']
                        #         )
                        #         received_ids.add(new_line.id)
                        #
                        # # ❌ DELETE (los que ya no vienen)
                        # to_delete = existing_ids - received_ids
                        # if to_delete:
                        #     ProductSupplier.objects.filter(id__in=to_delete).delete()
                        #################################################################
                        product = form.save()
                        ...
                        existing_ids = set(
                            ProductSupplier.objects.filter(product=product).values_list('id', flat=True)
                        )
                        ...
                        if to_create:
                            ProductSupplier.objects.bulk_create(to_create)

                        if to_update:
                            ProductSupplier.objects.bulk_update(
                                to_update,
                                ['price', 'partner', 'updated_by', 'updated_dt']
                            )
                ...
                suppliers = Partner.objects.filter(is_supplier=True ).values('id', 'name')
...
class CategoryListView(LoginRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('inventoryu:category_create')
        return context
...
class CategoryCreateView(LoginRequiredMixin,CreateView):
    ...
    success_url =  reverse_lazy('inventoryu:category_list')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('inventoryu:category_list')
        context['action'] = 'add'
        return context
...
class ProductUomListView(LoginRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('inventoryu:uom_create')
        return context
...
class ProductUomCreateView(LoginRequiredMixin,CreateView):
    ...
    success_url =  reverse_lazy('inventoryu:uom_list')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('inventoryu:uom_list')
        context['action'] = 'add'
        return context
