...
from appscore.inventory.forms import FractionMxForm,FractionUsForm,FractionHtsusForm,FractionUsExpForm
from appscore.inventory.models import  FractionMx, FractionUs, FractionHtsus,FractionUsExp
...
class FractionMxListView(LoginRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('inventoryu:fmx_create')
        return context
...
class FractionMxCreateView(LoginRequiredMixin,CreateView):
    ...
    success_url =  reverse_lazy('inventoryu:fmx_list')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('inventoryu:fmx_list')
        context['action'] = 'add'
        return context
...
class FractionHtsusListView(LoginRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('inventoryu:fhtsus_create')
        return context
...
class FractionHtsusCreateView(LoginRequiredMixin,CreateView):
    ...
    success_url =  reverse_lazy('inventoryu:fhtsus_list')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('inventoryu:fhtsus_list')
        context['action'] = 'add'
        return context
...
class FractionUsListView(LoginRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('inventoryu:fus_create')
        return context
...
class FractionUsCreateView(LoginRequiredMixin,CreateView):
    ...
    success_url =  reverse_lazy('inventoryu:fus_list')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('inventoryu:fus_list')
        context['action'] = 'add'
        return context
...
class FractionUsExpListView(LoginRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('inventoryu:fusexp_create')
        return context
...
class FractionUsExpCreateView(LoginRequiredMixin,CreateView):
    ...
    success_url =  reverse_lazy('inventoryu:fusexp_list')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('inventoryu:fusexp_list')
        context['action'] = 'add'
        return context
