    ...
    const table = new DataTable('#datatableid', {
        ...
        columnDefs: [{
            ...
            render: function (data, type, row) {
                var buttons =' <a href="/base/partner/edit/' + row.id + '/" class="btn btn-secondary btn-sm"  >  Editar </a> ';
                buttons +=' <a href="/base/partner/delete/' + row.id + '/" class="btn btn-secondary btn-sm"  > Elim </a>';
                return buttons;
            }
        }],
